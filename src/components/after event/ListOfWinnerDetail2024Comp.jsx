    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event IYPO 2024</h1>
            </div>
            <div className="low-detail-after-event-container">
                <div className="low-detail-after-event-row">
                    ...
                    <div className="low-detail-after-event-video">
                        <iframe className="mt-5"  width="100%" height="315" src="https://www.youtube.com/embed/jSwuxaUEj3Q?si=lLWDBrtuz83TUH87" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1OHHZIEE0Ge9gYCBDjHNZWtlT8_3LJYsw/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Curation</h2>
                        <br />
                        <a href="https://drive.google.com/drive/folders/1D1zF3ENJ8n9pHJ8b8pCZEFLVSpXxEhUk?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <div className="low-press-release-button-container">
                <a href="https://drive.google.com/file/d/1Kf-TDvAVoVyKQCjkXfioeJAMS4bZZYAA/view?usp=sharing" className="low-press-release-button">Download Press Release</a>
            </div>
        </section>
        <br />
        </>
